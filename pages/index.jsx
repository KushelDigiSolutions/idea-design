  ...
  return (
    <div className="indexwrap">
      ...
      <div id="First_section">
        <div className="seearbbar-containt">
          ...
          onChange={handleInputChange} />
              ...
              <svg onClick={handleSearch}  className="cursor-pointer"
                width="22"
                height="23"
                viewBox="0 0 22 23"
                fill="none"
        ...
        <div className="container">
          <div className="row">
            <div className="col-lg-6">
              <h1>
                Ditch the Struggle, Find Your Expert:{" "}
                <span> iWhims Connects</span>You to On-Demand Experts
              </h1>
              <p>
                We connect you with a network of trusted professionals, 24/7,
                across various fields - Law, Education, Finance, Healthcare, you
                name it!
              </p>
            </div>
          ...
          <div className="seconr-card-convert">
            <div className="red-sec2">
              ...
              <div className="title-sec2">
                ...
                <p>
                  Describe your situation or ask a question from our experts in
                  any of our categories, at any time.
                </p>
              </div>
            </div>
            <div className="blue-sec2">
              ...
              <div className="title-sec2">
                ...
                <p>
                  Our sophisticated matching system will connect you with the
                  best expert for your specific inquiry within minutes.
                </p>
              </div>
            </div>
            <div className="green-sec2">
              ...
              <div className="title-sec2">
                <h2>Interact with a Matched Expert</h2>
                <p>
                  Get personalized advice from your expert through text, call,
                  or in-person arrangements with unlimited access.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="container">
          <div className="row">
            ...
            <div className="col-lg-6">
              <p>Why ?</p>
              <h1>
                Ready to start by engaging <span>expert professionals.</span>
              </h1>
              <p>
                Book and meet over 12,06+ professionals for solutions in our
                global community.
              </p>
      ...
      <div id="fifth_section">
        ...
        <div className="fifth-container">
          ...
          <div className="fifth-main-sec">
            ...
            <div className="top-fifth-sec">
              ...
              <div className="five-right-heading">
                ...
                <div className="five-right-svg-btn">
                  <div className="five-prevbtn"  id="prev-btn">
                    <svg
                      onClick={scrollLeft}
                      width="42"
                      height="42"
                  ...
                  <div className="five-nextbtn" id="next-btn">
                    <svg
                      onClick={scrollRight}
                      width="42"
                      height="42"
            ...
            <div className="fifth-section-crouser-sec">
              <Swiper
                  ...
                  <div className="boottom-fifth-sec">
                    <div className="bottom-title">
                      ...
                      <div className="text-five-sec">
                        <p>
                          Research articles, case studies, clinical practice
                          updates.
                        </p>
      ...
      <div id="sixth_section">
        <div className="container-sixth">
          <div className="sixth-section">
            ...
            <p>
              We want to help you build an epic career with expert mentors. From
              junior to leadership, we are here to grow with you on this
              journey.
            </p>
          ...
          <div className="disconer-main-sec">
            ...
            <div className="top-fifth-sec">
              ...
              <div className="five-right-heading">
                ...
                <div className="five-right-svg-btn">
                  <div className="five-right-prevbtn"  id="prev-btn2">
                    <svg
                      onClick={scrollLeft2}
                      width="42"
                      height="42"
                  ...
                  <div className="five-right-nextbtn" id="next-btn2">
                    <svg
                ...
                <div className="salah-card-handler">
                  <div className="salah-page-main-content1">
                    ...
                    <div className=" salah-page-card-para">
                      <p>
                        Being new to the App world, the process of developing an
                        App seemed overwhelming to my company.
                      </p>
                    </div>
                  </div>
                </div>
        ...
        <div className="india-fav-container">
          <div className="india-fav-main">
            <div className="india-first-bane">
              <h2>
                India's favourite places to <span>get solutions?</span>
              </h2>
            </div>
      ...
      <div id="logo-slider-main">
        ...
        className="mySwiper4"
      >
        <SwiperSlide> <img src="./images/splide1.svg" alt="" /></SwiperSlide>
        <SwiperSlide> <img src="./images/splide2.svg" alt="" /></SwiperSlide>
        <SwiperSlide>  <img src="./images/splide3.svg" alt="" /></SwiperSlide>
        <SwiperSlide> <img src="./images/splide4.svg" alt="" /></SwiperSlide>
        <SwiperSlide><img src="./images/splide5.svg" alt="" /></SwiperSlide>
        <SwiperSlide> <img src="./images/splide6.svg" alt="" /></SwiperSlide>
          ...
          <div class="accordion accordion-flush" id="accordionFlushExample">
            <div class="accordion-item">
              <h2 class="accordion-header" id="flush-headingOne">
                <button
                  onClick={() => setStrat1(!start1)}
                  class="accordion-button faq22 collapsed"
                  type="button"
              ...
              <div
                ...
                class="accordion-collapse collapse faq223"
                aria-labelledby="flush-headingOne"
                data-bs-parent="#accordionFlushExample"
              >
                <div class="accordion-body">
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec
                  nisl felis, blandit in laoreet sed, malesuada id elit. Duis
                  sed odio blandit tortor maximus euismod. Phasellus convallis
                  dolor vel suscipit sagittis. Donec aliquam leo suscipit,
                  semper dui a, condimentum sem. 
                </div>
              </div>
            </div>
            <div class="accordion-item">
            ...
            <div className="contac-salah-container">
              <div className="left-main">
                ...
                <p>
                  ...
                  Speak your heart out. They listen with undivided attention to
                  resolve your concerns. Give us a call, request a callback or
                  drop an email, to
                </p>
              </div>
